...
public class DoNotChangeTest {
    ...
    private void validateInterfaceWeatherCollector() {
        ...
        Response getAirportResp = collector.getAirport(null);

        Response addAirportResp = collector.addAirport(null, null, null);

        Response deleteAirportResp = collector.deleteAirport(null);
    }
